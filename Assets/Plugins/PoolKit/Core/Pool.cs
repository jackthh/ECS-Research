...
namespace HellTap.PoolKit {
	...
	public class Pool : MonoBehaviour {
		...
		public void ExpandPoolSize(PoolItem poolItem, int size)
		{
			for (var i = poolItem.instanceCount; i < size; ++i)
			{
				var item = InstantiatePooledObject(poolItem, -1);
			}

			poolItem.poolSize = size;
		}
